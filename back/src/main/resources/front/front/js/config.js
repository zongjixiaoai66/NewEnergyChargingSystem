...
var centerMenu = [
    ...
    ,{
        name: '报修',
        url: '../baoxui/list.html'
    }
    ,{
        name: '充电桩预约',
        url: '../chongdianzhuangOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/xinnengyuanchongdainxitong/admin/dist/index.html#/login";
